...
export const WIDGET_CONFIG = {
  ...
  CDN_BASE_URL: process.env.NEXT_PUBLIC_CDN_URL || process.env.NEXT_PUBLIC_API_BASE_URL?.replace('/api/v1', '') || 'https://answer24_backend.test',
  
  // Security - Using your existing API base for signing
  SIGNING_SECRET: process.env.WIDGET_SIGNING_SECRET || 'your-widget-signing-secret-here',
