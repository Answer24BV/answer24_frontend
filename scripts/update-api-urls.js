...
const replacements = [
  {
    pattern: /const\s+API_BASE_URL\s*=\s*process\.env\.NEXT_PUBLIC_API_BASE_URL\s*\|\|\s*"https:\/\/answer24\.laravel\.cloud\/api\/v1";?/g,
    replacement: ''
  },
  {
    pattern: /const\s+BASE_URL\s*=\s*"https:\/\/answer24\.laravel\.cloud\/api\/v1";?/g,
    replacement: ''
  },
  {
    pattern: /process\.env\.NEXT_PUBLIC_API_BASE_URL\s*\|\|\s*"https:\/\/answer24\.laravel\.cloud\/api\/v1"/g,
  ...
  {
    pattern: /`\$\{process\.env\.NEXT_PUBLIC_API_BASE_URL\|\|"https:\/\/answer24\.laravel\.cloud\/api\/v1"\}/g,
    replacement: '`${API_CONFIG.BASE_URL}'
  }
];
...
function main() {
  ...
  console.log('\n📝 Next steps:');
  console.log('1. Create a .env.local file with: NEXT_PUBLIC_API_BASE_URL=https://your-api-url.com/api/v1');
