...
(function() {
    ...
    try {
      ...
      if (apiResp.ok) {
        ...
        if (apiJson && typeof apiJson === 'object') {
          ...
          console.log('[Answer24 Widget] Loaded settings from API', widgetSettings);
          try {
  ...
  function switchTab(tab) {
    ...
    const chatFooterBtn = document.getElementById('answer24-chat-button-footer');
  ...
  function updateFilePreview() {
    ...
    if (selectedFile) {
      ...
      infoDiv.innerHTML = `
        <div style="font-size: 14px; font-weight: 500; color: #374151; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;">${selectedFile.name}</div>
  ...
  function handleOptionClick(option) {
    ...
    setTimeout(() => {
      hideTyping();
      const responses = {
        "What is answer24?": "answer24 is your intelligent assistant platform designed to provide instant support and answers to your questions 24/7. We combine AI technology with human expertise to deliver accurate, helpful responses.",
        "Discover answer24 Premium": "answer24 Premium offers advanced features including priority support, extended conversation history, file analysis capabilities, and access to specialized knowledge domains. Would you like to learn more about upgrading?",
        "How can I log into my account?": "To log into your answer24 account, visit our website and click 'Sign In' in the top right corner. You can use your email and password, or sign in with Google or Microsoft. Need help resetting your password?",
        "Contact support": "I'm here to help! You can chat with me directly, or if you need human support, you can email us at support@answer24.nl or call our helpline. What specific issue can I assist you with?"
      };
      
      const response = responses[option] || `Here's more information about: ${option}`;
