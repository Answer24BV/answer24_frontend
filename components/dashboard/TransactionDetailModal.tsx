...
import { X, Calendar, CreditCard, DollarSign, FileText, Loader2 } from "lucide-react";
...
export default function TransactionDetailModal({
  ...
  useEffect(() => {
    ...
    const fetchTransactionDetail = async () => {
      console.log("🔍 [TRANSACTION MODAL] Fetching transaction:", transactionId);
      setLoading(true);
      setError(null);
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-2xl font-bold">{transaction.plan_name}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-medium text-sm">{formatDate(transaction.paid_at)}</p>
                </div>
