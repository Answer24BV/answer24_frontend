...
import { Plus, Edit, Trash2, Search, X, ChevronDown, ChevronUp, HelpCircle } from 'lucide-react'
...
import { getFAQs, createFAQ, updateFAQ, deleteFAQ } from '@/app/[locale]/actions/faq'
...
export function FaqAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingFaq) {
        ...
        setFaqs(prevFaqs =>
          prevFaqs.map(faq =>
            faq.id === editingFaq.id ? updatedItem : faq
          )
        );
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="space-y-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed p-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-foreground">No FAQs found</h3>
                  ...
                  <div className="space-y-4 pl-4">
                    {Object.entries(subcategories).map(([subcategory, items]) => (
                      <div key={subcategory} className="space-y-2">
                        <h3 className="text-md font-medium text-muted-foreground">{subcategory}</h3>
      ...
      {/* Edit/Create Panel */}
      <div
        className={`fixed inset-y-0 right-0 w-full max-w-md transform overflow-y-auto bg-background p-6 shadow-lg transition-transform duration-300 ease-in-out ${isPanelOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="subcategory" className="mb-1 block text-sm font-medium">
                Subcategory
              </label>
              <Input
                id="subcategory"
