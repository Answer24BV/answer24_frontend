...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all bg-white/95 duration-300 ${isScrolled ? " backdrop-blur-md shadow-lg border-b border-gray-200/50" : "bg-transparent"
        }`}
    >
