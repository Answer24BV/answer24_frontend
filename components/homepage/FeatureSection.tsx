...
const FeatureCard = ({
  ...
  return (
    ...
    >
      <Card
        className={`h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50/50 overflow-hidden relative ${
...
export function FeaturesSection() {
  ...
  const prevSlide = () =>
    scrollToIndex((currentIndex - 1 + features.length) % features.length);
