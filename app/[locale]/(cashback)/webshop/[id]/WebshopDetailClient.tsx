            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{webshopData.category}</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {webshopData.images.slice(1).map((image, index) => (
                <div key={index} className="aspect-square bg-white rounded-lg border overflow-hidden cursor-pointer hover:border-blue-500 transition-colors">
                  <img
                    src={image}
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {Object.entries(webshopData.specifications).map(([key, value]) => (
