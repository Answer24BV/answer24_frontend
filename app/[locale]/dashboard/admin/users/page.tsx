...
import { Search, Loader2, Edit, UserCheck, UserX, Mail, Phone } from 'lucide-react';
...
export default function AdminUsersPage() {
  ...
  const confirmToggleUserStatus = async () => {
    ...
    try {
      ...
      toast.success(`User ${userToToggle.name} has been ${action} successfully`);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
            ...
            <CardContent>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Badge className={`mt-2 ${getRoleColor(currentUser.role?.name || 'admin')}`}>
                  ...
                  <DialogContent className="max-h-[90vh] overflow-y-auto scrollbar-hide">
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button type="submit" disabled={isSubmitting} className="flex-1 bg-blue-600 hover:bg-blue-700 flex items-center gap-2 cursor-pointer">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-2">
                          <Badge className={getRoleColor(user.role?.name || 'client')}>
                            {user.role?.name}
                          </Badge>
        ...
        <ConfirmDialog
          ...
          title={userToToggle?.status === 'active' ? 'Suspend User' : 'Activate User'}
          description={
            userToToggle 
              ? `Are you sure you want to ${userToToggle.status === 'active' ? 'suspend' : 'activate'} ${userToToggle.name}? ${
          ...
          confirmText={userToToggle?.status === 'active' ? 'Suspend User' : 'Activate User'}
          cancelText="Cancel"
