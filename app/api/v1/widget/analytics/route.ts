...
export async function GET(request: NextRequest) {
  try {
    ...
    const analytics = await getWidgetAnalytics(publicKey, userId || undefined, dateRange);
  ...
  try {
    ...
    const mockAnalytics = {
      ...
      metrics: {
        ...
        total_revenue: 4027.50
      },
      breakdown: {
        by_day: [
          { date: '2024-01-15', interactions: 45, purchases: 2, cashback: 18.50 },
          { date: '2024-01-16', interactions: 52, purchases: 3, cashback: 27.30 },
          { date: '2024-01-17', interactions: 38, purchases: 1, cashback: 12.40 }
        ],
        by_shop: [
          { shop: 'Amazon', purchases: 15, cashback: 450.25 },
          { shop: 'Bol.com', purchases: 12, cashback: 380.50 },
          { shop: 'Coolblue', purchases: 8, cashback: 220.00 }
        ]
      }
    };
